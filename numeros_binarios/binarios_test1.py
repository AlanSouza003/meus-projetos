...
ano = date.today().year
def limpatela(): return os.system('cls' if os.name == 'nt' else 'clear')


data_formatada = (
    f'{cor["verde"]}DATA: {data:02d}/{mes:02d}/{ano}{cor["limpa"]}')
titulo = (f'{cor["ciano"]}{"NÚMEROS BINÁRIOS":^25}{cor["limpa"]}')
menu = (f'''{cor["amarelo"]}ESCOLHA A OPÇÃO DESEJADA:{cor["limpa"]}
{cor["verde"]}[ 1 ]{cor["limpa"]} {cor["branco"]}CONVERSÃO{cor["limpa"]}
{cor["verde"]}[ 2 ]{cor["limpa"]} {cor["branco"]}OPERAÇÕES BINÁRIAS{cor["limpa"]}
{cor["verde"]}[ 3 ]{cor["limpa"]} {cor["branco"]}TABELA VERDADE{cor["limpa"]}
{cor["verde"]}[ 4 ]{cor["limpa"]} {cor["branco"]}EXPRESSÕES BOOLEANAS{cor["limpa"]}
{cor["vermelho"]}[ 0 ]{cor["limpa"]} {cor["branco"]}ENCERRAR O PROGRAMA{cor["limpa"]}''')
subtitulo1 = (f'{cor["branco"]}┌─────────────────────┐{cor["limpa"]}\n'
              f'{cor["ciano"]}│      CONVERSÕES    │{cor["limpa"]}\n'
              f'{cor["branco"]}└─────────────────────┘{cor["limpa"]}')
submenu1 = (f'{cor["verde"]}[ 1 ]{cor["limpa"]} {cor["branco"]}DECIMAL{cor["limpa"]}\n'
            f'{cor["verde"]}[ 2 ]{cor["limpa"]} {cor["branco"]}BINÁRIO{cor["limpa"]}\n'
            f'{cor["verde"]}[ 3 ]{cor["limpa"]} {cor["branco"]}OCTAL{cor["limpa"]}\n'
            f'{cor["verde"]}[ 4 ]{cor["limpa"]} {cor["branco"]}HEXDECIMAL{cor["limpa"]}\n'
            f'{cor["vermelho"]}[ 0 ]{cor["limpa"]} {cor["branco"]}MENU PRINCIPAL{cor["limpa"]}')
tituloauxiliar1 = (f'{cor["branco"]}╔══════════════════════╗{cor["limpa"]}\n'
                   f'{cor["ciano"]}║   NÚMEROS DECIMAIS  ║{cor["limpa"]}\n'
                   f'{cor["branco"]}╚══════════════════════╝{cor["limpa"]}')
menuauxiliar1 = (f'{cor["verde"]}[ 1 ]{cor["limpa"]} {cor["verde"]}BINÁRIO{cor["limpa"]}\n'
                 f'{cor["verde"]}[ 2 ]{cor["limpa"]} {cor["azul"]}OCTAL{cor["limpa"]}\n'
                 f'{cor["verde"]}[ 3 ]{cor["limpa"]} {cor["roxo"]}HEXADECIMAL{cor["limpa"]}\n'
                 f'{cor["verde"]}[ 4 ]{cor["limpa"]} {cor["vermelho"]}MENU ANTERIOR{cor["limpa"]}')
escolhido = 0
escolhido_str = ''
while True:
    while True:  # Repetição do menu
        if escolhido_str != '0':
            limpatela()
        ...
        if escolhido_str.isdigit():
            ...
            if escolhido == 0 or 1 <= escolhido <= 4:
                ...
                print(f'{cor["vermelho"]}❌ ENTRADA INVÁLIDA!\n{cor["limpa"]}'
                      f'{cor["branco"]}DIGITE{cor["limpa"]} {cor["verde"]}[1-4]{cor["limpa"]} {cor["branco"]}ou{cor["limpa"]} '
    ...
    if escolhido == 1:
        ...
        while True:
            ...
            print(submenu1)
            print(f'{cor["branco"]}─{cor["limpa"]}' * 25)
            opcao_str = str(input(f'{cor["roxo"]}DIGITE SUA OPÇÃO '
                                  f'[DIGITE 0 PARA VOLTR]: {cor["limpa"]}')).strip()
            print()
        ...
        if opcao != 0:
            ...
            if escolha == 1:
                while True:
                    print(
                        f'{cor["amarelo"]}QUANTAS PARCELAS DESEJA:{cor["limpa"]}')
                    print(
        ...
        # ─────────────────────────────────────────────
            ...
            while True:
                while True:
                    print(
                        f'{cor["roxo"]}QUANTAS PROPOSIÇÕES DESEJA?{cor["limpa"]}')
                    print(
