...
if 1 <= escolhido <= 5:
    if escolhido == 1:
        print(f'{cor["branco"]}─{cor["limpa"]}' * 25)
        print(
            f'{cor["ciano"]}{"CONVERSOR DE DECIMAL":^25}\n'
        ...
        if escolha == 1:
            while True:
                ...
                print(f'{cor["branco"]}─{cor["limpa"]}' * 25)
                num_str = str(input(f'{cor["roxo"]}DIGITE AQUI: {cor["limpa"]}'))
                print(f'{cor["branco"]}─{cor["limpa"]}' * 25)
            ...
            if num == 1:
                ...
                while True:
                    n1_str = str(
                        input(f'{cor["branco"]}Primeira Parcela: {cor["limpa"]}')
                    )
                    n2_str = str(
                    ...
                    if all(c in "01" for c in n1_str) and all(
                        ...
                        result_str = (
                            str(result_bin[2:]).replace("1", "V").replace("0", "F")
                        )
                ...
                while True:
                    ...
                    if all(c in "01" for c in n1_str) and all(
                        ...
                        if somar_dec < 0:
                            ...
                            result_str2 = (
                                str(result_format).replace("1", "V").replace("0", "F")
                            )
                            result_colorido1 = (
                                result_str2.replace(
            ...
            if "a" <= valor1 <= "d" and "a" <= valor2 <= "d":
                ...
                if funcao == "and" or funcao == "or":
                    while True:
                        ...
                        print(f'{cor["branco"]}─{cor["limpa"]}' * 25)
                        if neg in ["SIM", "S", "N", "NÃO", "NAO"] and tabela in [
                            "b",
                            "c",
                            "d",
                        ]:
